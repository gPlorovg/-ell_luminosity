from PyQt5.QtWidgets import QApplication, QMainWindow, QButtonGroup, QVBoxLayout,\
    ...
    QGraphicsPixmapItem, QGraphicsEllipseItem, QGraphicsTextItem, QFileDialog, QMenu, QAction, QComboBox
...
class ThemeModeButton(QPushButton):
    def __init__(self, dark_mode):
        ...
        if dark_mode:
            self.setIcon(QIcon("../images/theme_mode_buttom_icons/dark_mode.png"))
        else:
            self.setIcon(QIcon("../images/theme_mode_buttom_icons/light_mode.png"))
...
class SettingsWindow(QMainWindow):
    ...
    def change_mode(self, dark_mode):
        if dark_mode:
            self.theme_mode_button.setIcon(QIcon("../images/theme_mode_buttom_icons/dark_mode.png"))
        else:
            self.theme_mode_button.setIcon(QIcon("../images/theme_mode_buttom_icons/light_mode.png"))
